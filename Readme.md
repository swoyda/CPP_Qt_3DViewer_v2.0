#### Проект написанн под Qt версии 6.6 (запускается и на 5.x, однако часть функционала перестает работать и отредактировать в Makefile QMake или совсем убрать ее)
